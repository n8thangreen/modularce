...
#' Native Markov Model calculation
#' @param start_pop Starting population array/matrix
#' @param p_matrix Transition probability matrix (or 3D array)
#' @param state_c_matrix State cost matrix
#' @param state_q_matrix State utility (QALY) matrix
#' @param n_cycles Number of cycles to run
#' @param s_names State names
#' @param t_names Treatment names
