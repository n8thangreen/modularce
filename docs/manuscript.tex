...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{DecisionTree }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(data) \{}
...
\NormalTok{  pathways }\OtherTok{\textless{}{-}} \FunctionTok{calculate\_pathways}\NormalTok{(model}\SpecialCharTok{$}\NormalTok{data)}
  ...
  \FunctionTok{list}\NormalTok{(}
      \AttributeTok{expected\_cost =} \FunctionTok{sum}\NormalTok{(pathways}\SpecialCharTok{$}\NormalTok{prob }\SpecialCharTok{*}\NormalTok{ pathways}\SpecialCharTok{$}\NormalTok{cost),}
      \AttributeTok{expected\_eff  =} \FunctionTok{sum}\NormalTok{(pathways}\SpecialCharTok{$}\NormalTok{prob }\SpecialCharTok{*}\NormalTok{ pathways}\SpecialCharTok{$}\NormalTok{eff),}
...
\NormalTok{    \}}
\NormalTok{    results[[i]] }\OtherTok{\textless{}{-}} \FunctionTok{run\_model}\NormalTok{(curr\_model)}
\NormalTok{  \}}
\NormalTok{  results}
\NormalTok{\}}
\end{Highlighting}
...
\NormalTok{t\_between\_screens }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{15}\NormalTok{, }\DecValTok{20}\NormalTok{)}
\NormalTok{num\_screens }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

The decision tree data are defined as a \texttt{tribble()} which allows
us to write it in the same format that it will be printed for clearer
code (\textbf{?@fig-code-input-dt}).
...
\NormalTok{dt }\OtherTok{\textless{}{-}} \FunctionTok{DecisionTree}\NormalTok{(decision\_tree)}
\NormalTok{scenario\_count }\OtherTok{\textless{}{-}} \DecValTok{1}
...
\NormalTok{  pair\_model\_scenario }\OtherTok{\textless{}{-}} 
    \FunctionTok{CombinedModel}\NormalTok{(dt, mm\_scenario)}
  
  \ControlFlowTok{for}\NormalTok{ (n\_scr }\ControlFlowTok{in}\NormalTok{ num\_screens) \{}
\NormalTok{    screening\_submodels }\OtherTok{\textless{}{-}} 
      \FunctionTok{rep}\NormalTok{(pair\_model\_scenario, n\_scr)}
\NormalTok{    screening\_model }\OtherTok{\textless{}{-}} 
      \FunctionTok{do.call}\NormalTok{(CombinedModel, }
              \AttributeTok{args =}\NormalTok{ screening\_submodels)}
\NormalTok{    results\_scenario }\OtherTok{\textless{}{-}} 
      \FunctionTok{run\_model}\NormalTok{(screening\_model)}
\NormalTok{    result\_label }\OtherTok{\textless{}{-}} 
      \FunctionTok{paste0}\NormalTok{(}\StringTok{"t\_between\_"}\NormalTok{, t\_val, }
             \StringTok{"\_screens\_"}\NormalTok{, n\_scr)}
...
\NormalTok{    all\_results[[result\_label]] }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
    ...
    \CommentTok{\# increment counter}
\NormalTok{    scenario\_count }\OtherTok{\textless{}{-}}\NormalTok{ scenario\_count }\SpecialCharTok{+} \DecValTok{1}
\NormalTok{  \}}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig-ce-plot}Cost-effectiveness plot for a range of
screening strategies; screening intervals of 2, 5, 10, 15, 20 years
(different colours), and total number of screening episodes 1, 2, 3, 4,
5, 10 (points along curves).}
